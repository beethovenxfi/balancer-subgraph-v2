...
export function handleNewGenericLinearPool(event: PoolCreated): void {
  handleNewLinearPool(event, PoolType.Linear);
}

export function handleNewGenericLinearPoolV2(event: PoolCreated): void {
