...
export let MIN_VIABLE_LIQUIDITY = BigDecimal.fromString('100');
...
export const FBEETS_ADDRESS = Address.fromString('0xfcef8a994209d6916eb2c86cdd2afd60aa6f54b1');
export const FBEETS_POOL_ID = Bytes.fromHexString('0xcde5a11a4acb4ee4c805352cec57e236bdbc3837000200000000000000000019');
